...
توسکی اپلیکیشن موبایل برای شبکه اجتماعی ماستودن است. در [این قسمت](https://crowdin.com/project/mastodon-for-android)  می‌توانید در ترجمه زبان کوردی این اپ  مشارکت کنید.
...
**پانل هاستیا**
هستیا پانل(Hestia Control Panel)، سیستمی برا مدیریت هاست سرورهای لینوکس می‌باشد که در عین کارآمدی و ساده بودن، بصورت منبع باز هم منتشر شده است. برای ویرایش ترجمه یا مشارکت در بهتر کردن زبان کردی می‌توانید به [این قسمت](https://translate.hestiacp.com/projects/hestiacp/) مراجعه فرمایید.
