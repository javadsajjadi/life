...
نرم افزاری تحت ویندوز(سرویس خواه) برای استفاده از شبکه اجتماعی ماستودن.در [این قسمت](https://github.com/elk-zone/elk/tree/main/locales)  می‌توانید در ترجمه زبان کوردی این نرم‌افزار مشارکت کنید.
